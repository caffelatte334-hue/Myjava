...
public class Product03 {
    ...
    public Product03(String name, String inputdate){
     ...
     public Product03(String name, int price, String inputdate){
      ...
      this.price = price; // 객체 자신(this)이 소유한 price 변수에 매개 변수 price의 값을 할당하시오
      this.inputdate = inputdate; // 객체 자신(this)이 소유한 inputdate 변수에 매개 변수 inputdate의 값을 할당하시오
